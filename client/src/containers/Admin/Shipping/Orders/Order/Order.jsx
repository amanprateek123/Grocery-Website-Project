    ...
    return (
        <div className="admin-order">
            ...
            <div className="row status">
                ...
                ><Lock style={{ fontSize: '1.2em', marginRight: '5px' }} /> Ordered</div>
                ...
                > <Lock style={{ fontSize: '1.2em', marginRight: '5px' }} /> Packed</div>
                ...
                ><Lock style={{ fontSize: '1.2em', marginRight: '5px' }} /> Shipped</div>
