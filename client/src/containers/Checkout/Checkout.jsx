 ...
 cart.forEach(itm=>{
    ...
    return (
        <div>
           ...
           (<div className="empty" style={{width:'500px',float:'right',backgroundColor:'#f3f3f3',height:'200px',textAlign:'center',position:'fixed',top:'5.8%',left:'50.66%',zIndex:'20',display:'flex'}}>
